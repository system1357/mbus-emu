...
void IRAM_ATTR gpio_isr_bt_input_audio(void* arg) { //todo handle bt audio
    emuBTMode(gpio_get_level(GPIO_BT_INPUT_AUDIO));
}

void IRAM_ATTR gpio_isr_bt_input_call(void* arg) { //todo handle bt call
    emuPhoneMode(gpio_get_level(GPIO_BT_INPUT_CALL));
}

void IRAM_ATTR gpio_isr_intcd_status(void* arg) { //todo handle bt call
